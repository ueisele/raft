...
// TestAsymmetricPartition - moved to partition_test_refactored.go
// This test has been refactored to use transport decorators
// See partition_test_refactored.go for the updated implementation

// TestAsymmetricPartition has been moved to partition_test_refactored.go
// The refactored version uses transport decorators for cleaner partition simulation
